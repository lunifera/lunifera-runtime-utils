...
public class TestBundleAnalyzer extends TestCase {
    ...
    public void testContentAndIdentity() throws Exception {
        ...
        File url = new File((String) content.getAttributes()
                .get("url")); 
        assertEquals(true, url.toPath().endsWith("testdata/01-bsn+version.jar"));
        assertEquals("application/vnd.osgi.bundle", content.getAttributes()
                .get("mime"));
    ...
    public void testPackageExports() throws Exception {
        ...
        assertEquals(new Version(1, 0, 0), export.getAttributes()
                .get("version"));
    }
    ...
    public void testPackageExportUses() throws Exception {
        ...
        a.analyzeResource(
                new JarResource(new File(getClass().getResource(
                        "/testdata/04-export+uses.jar").getPath())), caps, reqs);
        ...
        assertEquals("org.example.a", exports.get(0).getDirectives()
                .get("uses"));
        assertEquals("org.example.a",
    ...
    public void testPackageImports() throws Exception {
        ...
        a.analyzeResource(
                new JarResource(new File(getClass().getResource(
                        "/testdata/05-import.jar").getPath())), caps, reqs);
    ...
    public void testRequireBundle() throws Exception {
        ...
        a.analyzeResource(
                new JarResource(new File(getClass().getResource(
                        "/testdata/06-requirebundle.jar").getPath())), caps,
                reqs);
    ...
    public void testPackageImportOptional() throws Exception {
        ...
        a.analyzeResource(
                new JarResource(new File(getClass().getResource(
                        "/testdata/07-optionalimport.jar").getPath())), caps,
                reqs);
    ...
    public void testFragmentHost() throws Exception {
        ...
        a.analyzeResource(
                new JarResource(new File(getClass().getResource(
                        "/testdata/08-fragmenthost.jar").getPath())), caps,
                reqs);
