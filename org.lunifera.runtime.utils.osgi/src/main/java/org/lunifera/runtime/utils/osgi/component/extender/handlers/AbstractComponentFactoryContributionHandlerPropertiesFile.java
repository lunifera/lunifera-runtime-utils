 ...
 * @since 0.0.1
 */
public abstract class AbstractComponentFactoryContributionHandlerPropertiesFile
        extends AbstractComponentFactoryContributionHandler {

    /**
     * A default constructor is required by the OSGi Declarative Service.
     */
    public AbstractComponentFactoryContributionHandlerPropertiesFile() {
        super();
    }
     ...
     */
    protected AbstractComponentFactoryContributionHandlerPropertiesFile(
    ...
    /**
     * Split the header values and put them into a map.
     * 
     * @param header
     * @return
     */
